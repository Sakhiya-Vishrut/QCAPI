...
namespace QCLorence.Common.Utility
{
    public static class CommonHelper
    {
        public static string GenerateOrderNumber()
        {
            ...
            string uniquePart = Guid.NewGuid().ToString("N").Substring(0, 4); // short unique suffix
            string orderNumber = $"ORD-{indiaTime:yyyyMMddHHmmssfff}{uniquePart.ToUpper()}";
            return orderNumber;
        }
        public static string FormatImageURL(string imageUrl)
        {
            return ConstantMessage.CommonImageURLPrefix + imageUrl;
        }
        public static string GenerateInvoiceNumber()
        {
            ...
            return "INV-" + indiaTime.ToString("yyyyMMddHHmmss");
        ...
        {
            string data = $"{timestampString}-{"QCLorenceSecretKey"}";
        ...
        public static string GetQCLorenceNumberString(string QCLorenceNumber)
        {
            if (string.IsNullOrEmpty(QCLorenceNumber) == false && QCLorenceNumber.Length == 16)
            {
                var f4 = QCLorenceNumber.Substring(0, 4);
                var f8 = f4 + " " + QCLorenceNumber.Substring(4, 4);
                var f12 = f8 + " " + QCLorenceNumber.Substring(8, 4);
                var f16 = f12 + " " + QCLorenceNumber.Substring(12, 4);

                return f16;
            }

            return QCLorenceNumber;
        }
